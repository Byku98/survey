...
public class ParticipantAuthJWTService implements IAuthJWTService<ParticipantEntity> {
     ...
     * @param userGoogleJwt
     */
    public ParticipantAuthResponseDto authenticateParticipant(String userGoogleJwt) {
...
//        log.info(participantEntity.getDueDate().toString());
    ...
    public ResponseEntity<Void> deleteJWT(String token) {
        ...
        Optional<ParticipantEntity> participantData = participantRepository.findByTokenValue(token);
        ...
        try {
            ParticipantEntity participantEntity = participantData.get();
            participantEntity.setTokenValue(null);
            participantEntity.setDueDate(null);
            participantRepository.save(participantEntity);
            return ResponseEntity.ok().build();
